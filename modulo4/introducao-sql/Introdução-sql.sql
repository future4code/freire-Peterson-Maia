...
-- Exercício 1 -- 1)A) O varchar é utilizado para representar strings. -- Data representa que é uma data -- a Primary key representa o id

-- b) O show database me retorna as informações meu registro no SQL -- O show tables me retorna informções de arquivos que eu criei
...
insert into Actor(id,name,salary, birth_date, gender) values("004", "Tony Ramos",400000,"1949-04-18", "male" );
...
insert into Actor(id,name,salary, birth_date, gender) values("006", "yasmin silva", 1000000, "2002-11-29", "female");
...
insert into filmes(id, nome, sinopse, release_date, rating) values( "003", "Dona Flor e Seus Dois Maridos", "Dona Flor é uma sedutora professora de culinária casada com Vadinho, que só quer saber de farras e jogatina nas boates. A vida de abusos acaba por acarretar sua morte precoce.", 02/11/2017, 8 );
